...
int main(int argc, char **argv){
	ros::init(argc, argv, "circle_SevenJointPublisher");
	ros::NodeHandle n;
...
// pack position
    ...
    //calc point
  	circlePoint.name.push_back("rod_one_joint");
  	circlePoint.name.push_back("rod_two_joint");
    circlePoint.name.push_back("rod_three_joint");
    circlePoint.name.push_back("rod_four_joint");
    circlePoint.name.push_back("rod_five_joint");
    circlePoint.name.push_back("rod_six_joint");
