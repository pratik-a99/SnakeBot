...
class LinearProgessionGait():
    def __init__(self, publishers, num_joints=10):
        ...
        self.amplitudes, self.omegas, self.phases, self.axis_lags = self.amplitudes, self.omegas, self.phases, self.axis_lags[::-1]
        self.publishers = publishers

    def get_angle_params(self, num_joints):


        amp_reduction_factor_hor = 0.9 #1.5 #0.4
        amp_reduction_factor_ver = 0.9 #1.5 #0.1
