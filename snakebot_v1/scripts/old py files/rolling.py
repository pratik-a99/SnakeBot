...
class RollingGait(Gait):
    ...
    def get_angle_params(self, num_joints):
        ...
        amp_reduction_factor_hor = -0.4 #1.5 #0.4  --- negate this term alone
...
if __name__=="__main__":
    ...
    rospy.init_node('snakebot_rolling', anonymous=True)
    
    num_joints = 10
    joint_publishers = get_publisher_nodes(num_joints=num_joints)
    gait = RollingGait(publishers=joint_publishers, num_joints=num_joints)
